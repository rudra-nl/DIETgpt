...
module.bundle.HMR_BUNDLE_ID = "9bebfd1e3ec65b8e";
"use strict";
...
const GOOGLE_API_KEY = "AIzaSyDi0ApdpLINgB7AjgzQz6T1zqAP5j59bKw";
...
async function sendMessage() {
    ...
    input.value = "";
    // show user message
    chatBox.insertAdjacentHTML("beforeend", `<div class="user"><p>${userMessage}</p></div>`);
    // loader
    ...
    try {
        ...
        chatBox.insertAdjacentHTML("beforeend", `<div class="model"><p>${response.text}</p></div>`);
        history.push({
            role: "user",
            parts: [
                {
        ...
        document.querySelector(".loader")?.remove();
        chatBox.insertAdjacentHTML("beforeend", `<div class="error"><p>Error. Try again.</p></div>`);
        console.error(err);
    }
}
...
},{"@google/genai":"cPvSL"}],"cPvSL":[function(require,module,exports,__globalThis) {
/**
 * @license
...
parcelHelpers.export(exports, "CancelTuningJobResponse", ()=>CancelTuningJobResponse);
...
parcelHelpers.export(exports, "ContentReferenceImage", ()=>ContentReferenceImage);
...
parcelHelpers.export(exports, "DocumentState", ()=>DocumentState);
...
parcelHelpers.export(exports, "FunctionResponseBlob", ()=>FunctionResponseBlob);
parcelHelpers.export(exports, "FunctionResponseFileData", ()=>FunctionResponseFileData);
parcelHelpers.export(exports, "FunctionResponsePart", ()=>FunctionResponsePart);
...
parcelHelpers.export(exports, "GenerateVideosOperation", ()=>GenerateVideosOperation);
...
parcelHelpers.export(exports, "HttpElementLocation", ()=>HttpElementLocation);
...
parcelHelpers.export(exports, "ImportFileOperation", ()=>ImportFileOperation);
parcelHelpers.export(exports, "ImportFileResponse", ()=>ImportFileResponse);
parcelHelpers.export(exports, "InlinedEmbedContentResponse", ()=>InlinedEmbedContentResponse);
...
parcelHelpers.export(exports, "ListDocumentsResponse", ()=>ListDocumentsResponse);
parcelHelpers.export(exports, "ListFileSearchStoresResponse", ()=>ListFileSearchStoresResponse);
...
parcelHelpers.export(exports, "MusicGenerationMode", ()=>MusicGenerationMode);
...
parcelHelpers.export(exports, "PartMediaResolutionLevel", ()=>PartMediaResolutionLevel);
parcelHelpers.export(exports, "PersonGeneration", ()=>PersonGeneration);
parcelHelpers.export(exports, "PhishBlockThreshold", ()=>PhishBlockThreshold);
parcelHelpers.export(exports, "RawReferenceImage", ()=>RawReferenceImage);
parcelHelpers.export(exports, "RecontextImageResponse", ()=>RecontextImageResponse);
...
parcelHelpers.export(exports, "SegmentImageResponse", ()=>SegmentImageResponse);
parcelHelpers.export(exports, "SegmentMode", ()=>SegmentMode);
parcelHelpers.export(exports, "Session", ()=>Session);
parcelHelpers.export(exports, "SingleEmbedContentResponse", ()=>SingleEmbedContentResponse);
...
parcelHelpers.export(exports, "ThinkingLevel", ()=>ThinkingLevel);
parcelHelpers.export(exports, "Tokens", ()=>Tokens);
parcelHelpers.export(exports, "TrafficType", ()=>TrafficType);
parcelHelpers.export(exports, "TuningMethod", ()=>TuningMethod);
parcelHelpers.export(exports, "TuningMode", ()=>TuningMode);
parcelHelpers.export(exports, "TuningTask", ()=>TuningTask);
parcelHelpers.export(exports, "TurnCompleteReason", ()=>TurnCompleteReason);
parcelHelpers.export(exports, "TurnCoverage", ()=>TurnCoverage);
parcelHelpers.export(exports, "Type", ()=>Type);
parcelHelpers.export(exports, "UploadToFileSearchStoreOperation", ()=>UploadToFileSearchStoreOperation);
parcelHelpers.export(exports, "UploadToFileSearchStoreResponse", ()=>UploadToFileSearchStoreResponse);
parcelHelpers.export(exports, "UploadToFileSearchStoreResumableResponse", ()=>UploadToFileSearchStoreResumableResponse);
...
parcelHelpers.export(exports, "VadSignalType", ()=>VadSignalType);
parcelHelpers.export(exports, "VideoCompressionQuality", ()=>VideoCompressionQuality);
parcelHelpers.export(exports, "VideoGenerationMaskMode", ()=>VideoGenerationMaskMode);
parcelHelpers.export(exports, "VideoGenerationReferenceType", ()=>VideoGenerationReferenceType);
parcelHelpers.export(exports, "createFunctionResponsePartFromBase64", ()=>createFunctionResponsePartFromBase64);
parcelHelpers.export(exports, "createFunctionResponsePartFromUri", ()=>createFunctionResponsePartFromUri);
 ...
 */ function moveValueByPath(data, paths) {
    for (const [sourcePath, destPath] of Object.entries(paths)){
        ...
        if (wildcardIdx !== -1 && destKeys.length > wildcardIdx) // Extract the intermediate key between source and dest paths
 ...
 */ function _moveValueRecursive(data, sourceKeys, destKeys, keyIdx, excludeKeys) {
    ...
    } else if (key === '*') // wildcard - move all fields
    {
...
function tBatchJobSource(client, src) {
    ...
    } else // It's already a BatchJobSource object
    sourceObj = src;
    // Validation logic
...
function tRecvBatchJobDestination(dest) {
    ...
    if (typeof dest !== 'object' || dest === null) // If the input is not an object, it cannot be a valid BatchJobDestination
 ...
 */ class Batches extends BaseModule {
    constructor(apiClient){
         ...
         */ this.create = async (params)=>{
            if (this.apiClient.isVertexAI()) // Format destination if not provided
    ...
    formatDestination(src, config) {
        ...
        if (newConfig.dest === undefined) {
            ...
            if (gcsUri) {
                if (gcsUri.endsWith('.jsonl')) // For .jsonl files, remove suffix and add /dest
                newConfig.dest = `${gcsUri.slice(0, -6)}/dest`;
                else // Fallback for other GCS URIs
    ...
    async includeExtraHttpOptionsToRequestInit(requestInit, httpOptions, url, abortSignal) {
        if (httpOptions && httpOptions.timeout || abortSignal) {
            ...
            if (httpOptions.timeout && (httpOptions === null || httpOptions === void 0 ? void 0 : httpOptions.timeout) > 0) {
                ...
                if (timeoutHandle && typeof timeoutHandle.unref === 'function') // call unref to prevent nodejs process from hanging, see
            ...
            try {
                ...
                while(true){
                    ...
                    while(true){
                        ...
                        if (delimiterIndex === -1) break; // No complete event in buffer
...
function makeReadableStream(...args) {
    ...
    if (typeof ReadableStream === 'undefined') // Note: All of the platforms / runtimes we officially support already define
...
function makeLogFn(fnLevel, logger, logLevel) {
    ...
    else // Don't wrap logger functions, we want the stacktrace intact!
 ...
 */ class BaseGeminiNextGenAPIClient {
    ...
    async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
        ...
        /** Not an API request ID, just for correlating local log entries. */ const requestLogID = 'log_' + (Math.random() * 16777216 | 0).toString(16).padStart(6, '0');
    ...
    async fetchWithTimeout(url, init, ms, controller) {
        ...
        if (method) // Custom methods like 'patch' need to be uppercased
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        globalThis.ReadableStream && body instanceof globalThis.ReadableStream) return {
            bodyHeaders: undefined,
            body: body
        };
 ...
 */ class GoogleGenAI {
    get interactions() {
        ...
        if (this.vertexai) throw new Error('This version of the GenAI SDK does not support Vertex AI API for interactions.');
